        ...
        <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8' >
         ...
         {/*form */}
          <form className='flex flex-col gap-y-4'>
            <input className='border border-gray-400 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm' type="text" placeholder='Name'/>
            <input className='border border-gray-400 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm' type="text" placeholder='Email'/>
            <input className='border border-gray-400 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm' type="text" placeholder='Phone'/>
